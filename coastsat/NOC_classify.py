    ...
    for satname in metadata.keys():
        ...
        for i in range(len(filenames)):
            ...
            # otherwise label this image
                ...
                im_ww_water_land1_land2_land3 = im_viz.copy()
...
def evaluate_classifier_6classes(classifier, metadata, settings, base_path):
    """
    Apply the image classifier to all the images and save the classified images.
    ...
    for satname in metadata.keys():
        ...
        for i in range(len(filenames)):
            ...
            # classify image in 4 classes (sand, whitewater, water, other) with NN classifier
            im_classif, im_labels = NOC_shoreline.classify_image_NN_6classes(im_ms, cloud_mask,
                                                                     min_beach_area_pixels, classifier)
